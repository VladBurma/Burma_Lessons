function binaryAgent(str) {
    ...
    /* Створюємо новий масив у який будемо записувати декодовані символи.
    Робимо масив зі значень переданої строки розділяючи їх пробілом.
    І пробігаємомь по масиву декодуючи кожне значення та пушимо його в arrFinal,
    який в кінці обʼєднаємо в одну строку
    */
    ...
    arr.forEach(item => {
        arrFinal.push(String.fromCharCode(parseInt(item, 2)));
    });
